...
-- -----------------------------------------------------
-- Table `citymis`.`system_student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `citymis`.`system_student` (
...
-- -----------------------------------------------------
-- Table `citymis`.`system_teacher`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `citymis`.`system_teacher` (
  `id` BIGINT(18) NOT NULL COMMENT '主键',
...
-- -----------------------------------------------------
-- Table `citymis`.`system_college`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `citymis`.`system_college` (
  `id` BIGINT(18) NOT NULL COMMENT '主键',
...
-- -----------------------------------------------------
-- Table `citymis`.`system_profession`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `citymis`.`system_profession` (
...
-- -----------------------------------------------------
-- Table `citymis`.`system_teacher_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `citymis`.`system_teacher_role` (
